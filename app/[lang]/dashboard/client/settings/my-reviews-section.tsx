...
export default function MyReviewsSection() {
  const { data, isLoading } = useQuery<ApiResponse<ReviewItem[]>>({
    queryKey: ["my-reviews"],
          ...
          {isLoading ? (
            ...
            <div className="text-center py-8 text-gray-500">
              ...
              <p className="text-sm mt-1">
                Complete a project and leave a review for the freelancer.
              </p>
            </div>
          ) : (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    <div className="flex items-center gap-3">
                      <Avatar
                        src={review.seller.image ?? undefined}
                        fallback={review.seller.firstName?.[0] ?? "?"}
                        size="3"
                        radius="full"
                      />
                      <div>
                  ...
                  <p className="text-xs text-gray-400 mb-2">
                    Project: {review.job?.title || "N/A"} &middot;{" "}
