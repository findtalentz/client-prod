...
export default async function BuyerLayout({ children, params }: Props) {
  ...
  const items = [
    ...
    },
    {
      id: 3,
      label: t.talents,
      path: `/${lang}/dashboard/client/talents`,
      icon: <LuSearchCode />,
    },
    {
      id: 4,
      label: t.messages,
      path: `/${lang}/dashboard/client/messages`,
      icon: <MdOutlineMessage />,
    },
    {
      id: 5,
      label: t.paymentMethods,
      path: `/${lang}/dashboard/client/payment-methods`,
      icon: <MdOutlinePayment />,
    },
    {
      id: 6,
      label: t.settings,
      path: `/${lang}/dashboard/client/settings`,
      icon: <FaGear />,
    },
    {
      id: 7,
      label: t.notifications,
      path: `/${lang}/dashboard/client/notifications`,
      icon: <FaBell />,
    },
    {
      id: 8,
      label: t.royaltyProgram,
      path: `/${lang}/dashboard/client/royalty-program`,
      icon: <RiVerifiedBadgeLine />,
    },
    {
      id: 9,
      label: t.calendar,
      path: `/${lang}/dashboard/client/calendar`,
      icon: <LuCalendarDays />,
    },
  ];
